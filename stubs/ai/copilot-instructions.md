...
7. Ensure all data-attribute contracts are preserved: `data-search-trigger`, `data-theme-toggle`, `data-theme-icon`, `data-copy-code`, `data-mermaid-zoom-in/out/reset/fullscreen`, and standard element IDs.
