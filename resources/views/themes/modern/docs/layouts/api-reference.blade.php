{{-- Modern Theme — API Reference Page Layout --}}
...
@section('body')
    ...
    <main id="main-content" class="flex-1 flex flex-col lg:flex-row min-w-0">
            ...
            <article class="docs-content">
                ...
                <div class="mb-10">
                    <h3 class="text-lg font-bold mb-4 flex items-center gap-2">
                        Request Body
                        <span class="text-[11px] font-medium text-[var(--docs-text-muted)] px-2 py-0.5 border border-[var(--docs-border)] rounded">application/json</span>
                    </h3>
                ...
                <div class="mb-10">
                    ...
                    <div class="space-y-3">
                        ...
                        @endphp
                        <div class="flex items-center gap-4 p-4 rounded-xl border-l-3 {{ $borderColor }} bg-[var(--docs-bg-secondary)]">
        ...
        {{-- Try It Out Panel --}}
        @if(!empty($endpointMethod) && !empty($endpointPath))
        <div class="w-full lg:w-[400px] docs-tryit-panel p-5 lg:sticky lg:top-16 h-[calc(100vh-64px)] overflow-y-auto border-l border-[var(--docs-border)] docs-thin-scrollbar">
            <div class="mb-6">
                ...
                <div class="relative bg-[var(--color-code-bg)] rounded-lg p-4 font-mono text-xs group border border-[var(--color-code-border)]">
                    <button class="absolute top-3 right-3 p-1.5 bg-[var(--color-code-header)] rounded opacity-0 group-hover:opacity-100 transition-opacity" data-copy-code>
                        <span class="material-symbols-outlined text-sm text-[var(--docs-text-muted)]">content_copy</span>
                    </button>
            ...
            <div class="space-y-5">
                ...
                <button class="w-full py-2.5 bg-[var(--color-primary)] text-white rounded-lg font-semibold text-sm hover:bg-[var(--color-primary-dark)] transition-colors flex items-center justify-center gap-2">
            ...
            <div class="mt-6 pt-6 border-t border-[var(--color-code-border)]">
                ...
                <div class="bg-[var(--color-code-bg)] border border-[var(--color-code-border)] rounded-lg p-4 font-mono text-xs min-h-28 text-[var(--docs-text-muted)] flex items-center justify-center">
                    <div class="text-center">
                        <span class="material-symbols-outlined block text-2xl mb-1.5 opacity-40">terminal</span>
